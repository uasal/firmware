# Written by Synplify Pro version map202209actsp2, Build 145R. Synopsys Run ID: sid1729889054 
...
create_clock -period 10.000 -waveform {0.000 5.000} -name {VariableClockDividerPorts_work_main_architecture_main_0layer1_1|clko_i_inferred_clock} [get_pins {Main_0/Uart3BitClockDiv/clko_i/Q}] 
create_clock -period 10.000 -waveform {0.000 5.000} -name {ClockDividerPorts_work_main_architecture_main_0layer1_2|div_i_inferred_clock} [get_pins {Main_0/Uart2TxBitClockDiv/div_i/Q}] 
create_clock -period 10.000 -waveform {0.000 5.000} -name {VariableClockDividerPorts_work_main_architecture_main_0layer1_2|clko_i_inferred_clock} [get_pins {Main_0/Uart2BitClockDiv/clko_i/Q}] 
create_clock -period 10.000 -waveform {0.000 5.000} -name {ClockDividerPorts_work_main_architecture_main_0layer1_3|div_i_inferred_clock} [get_pins {Main_0/Uart1TxBitClockDiv/div_i/Q}] 
create_clock -period 10.000 -waveform {0.000 5.000} -name {VariableClockDividerPorts_work_main_architecture_main_0layer1_3|clko_i_inferred_clock} [get_pins {Main_0/Uart1BitClockDiv/clko_i/Q}] 
create_clock -period 10.000 -waveform {0.000 5.000} -name {ClockDividerPorts_work_main_architecture_main_0layer1_4|div_i_inferred_clock} [get_pins {Main_0/Uart0TxBitClockDiv/div_i/Q}] 
create_clock -period 10.000 -waveform {0.000 5.000} -name {VariableClockDividerPorts_work_main_architecture_main_0layer1_4|clko_i_inferred_clock} [get_pins {Main_0/Uart0BitClockDiv/clko_i/Q}] 
...
set Inferred_clkgroup_2 [list VariableClockDividerPorts_work_main_architecture_main_0layer1_0|clko_i_inferred_clock]
set Inferred_clkgroup_3 [list ClockDividerPorts_work_main_architecture_main_0layer1_1|div_i_inferred_clock]
set Inferred_clkgroup_4 [list VariableClockDividerPorts_work_main_architecture_main_0layer1_1|clko_i_inferred_clock]
set Inferred_clkgroup_5 [list ClockDividerPorts_work_main_architecture_main_0layer1_2|div_i_inferred_clock]
set Inferred_clkgroup_6 [list VariableClockDividerPorts_work_main_architecture_main_0layer1_2|clko_i_inferred_clock]
set Inferred_clkgroup_7 [list ClockDividerPorts_work_main_architecture_main_0layer1_3|div_i_inferred_clock]
set Inferred_clkgroup_8 [list VariableClockDividerPorts_work_main_architecture_main_0layer1_3|clko_i_inferred_clock]
set Inferred_clkgroup_9 [list ClockDividerPorts_work_main_architecture_main_0layer1_4|div_i_inferred_clock]
set Inferred_clkgroup_10 [list VariableClockDividerPorts_work_main_architecture_main_0layer1_4|clko_i_inferred_clock]
set Inferred_clkgroup_11 [list FineSteeringMirror_sb_CCC_0_FCCC|GL0_net_inferred_clock]
