...
/* These are the command codes.  That is, Payload Types.  The number sent for a particular command */
/* For future: make numbers different enough to prevent corrupt data from issuing an unintended command */
/* Expand commands to encompass both Ux1 and Ux2 FPGAs */
/* Ux1 Commands */
...
static const uint16_t CGraphPayloadTypeHVSwitch = 0x0007U; // Payload: 2 uint32's

/* Undetermined command at this time */
