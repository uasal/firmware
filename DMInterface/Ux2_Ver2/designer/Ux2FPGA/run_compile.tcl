...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"C:\Users\SKaye\repos7\firmware\DMInterface\Ux2_Ver2\synthesis\Ux2FPGA.vm"}
set_compile_info \
    -category {"Options"} \
...
set_compile_info \
    ...
    -value {"10"}
compile \
    -desdir {C:\Users\SKaye\repos7\firmware\DMInterface\Ux2_Ver2\designer\Ux2FPGA} \
    -design Ux2FPGA \
    -fam SmartFusion2 \
    -die PA4M2500_N \
    -pkg vf256 \
