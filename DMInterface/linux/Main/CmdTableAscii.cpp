...
const Cmd AsciiCmds[] =
{
    ...
    Cmd(
        "DMCIDACS",
        "\"DMCIDacs <A>,<B>,<C>\": Sets/queries the DMCI D/A's (hexadecimal lsb units).",
        DMCIDacsCommand
    ),
	
	Cmd(
        "D",
        "\"D(DMCIDacs) <A>,<B>,<C>\": Sets/queries the DMCI D/A's (hexadecimal lsb units).",
        DMCIDacsCommand
    ),
	
	Cmd(
        "VOLTAGE",
        "\"Voltage <A>,<B>,<C>\": Sets/queries the DMCI D/A's (decimal voltage units).",
        VoltageCommand
    ),
	
	Cmd(
        "V",
        "\"V(oltage) <A>,<B>,<C>\": Sets/queries the DMCI D/A's (decimal voltage units).",
        VoltageCommand
    ),
	
	Cmd(
        "DMCIADCS",
        "\"DMCIAdcs <A>,<B>,<C>\": Sets/queries the DMCI A/D's.",
        DMCIAdcsCommand
    ),
	
	Cmd(
        "A",
        "\"A(DMCIAdcs) <A>,<B>,<C>\": Sets/queries the DMCI A/D's.",
        DMCIAdcsCommand
    ),
