...
class DMCI_pinout_FPGAUart2 : public IUart
{
public:

	DMCI_pinout_FPGAUart2() : IUart() { }
	virtual ~DMCI_pinout_FPGAUart2() { }
...
public:
	...
	{
		if (NULL == DMCI) { return(false); }
		CGraphDMCIUartStatusRegister UartStatus = DMCI->UartStatusRegister1;
		return(0 == UartStatus.Uart2RxFifoEmpty);
	}
...
class DMCI_pinout_FPGAUart0 : public IUart
{
public:

	DMCI_pinout_FPGAUart0() : IUart() { }
	virtual ~DMCI_pinout_FPGAUart0() { }
	...
	{
		if (NULL == DMCI) { return(false); }
		CGraphDMCIUartStatusRegister UartStatus = DMCI->UartStatusRegister0;
		return(0 == UartStatus.Uart2RxFifoEmpty);
	}
