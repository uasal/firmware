...
#include "timing/MountainOpsHwTypes.h"
#include "SensorBoardTypes.h"
...
bool ProcessUserInterface()
{
	...
	//Listen for ascii commands from the keyboard (stdin), and send them out the uart to the SensorBoard
...
void* StdInClientThread(void *argument)
{
	printf("\nSensorBoardServer: StdInClientThread() started...\n");
