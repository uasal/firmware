...
const ddr_subsys_cfg_t g_m2s_mddr_subsys_config =
{
     ...
     */
    {
        ...
        MDDR_DDRC_INIT_1_CR,
        MDDR_DDRC_CKE_RSTN_CYCLES_CR1,
        MDDR_DDRC_CKE_RSTN_CYCLES_CR2,
        ...
        MDDR_DDRC_ZQ_SHORT_INT_REFRESH_MARGIN_CR1,
        MDDR_DDRC_ZQ_SHORT_INT_REFRESH_MARGIN_CR2,
        MDDR_DDRC_PERF_PARAM_1_CR,
        MDDR_DDRC_HPR_QUEUE_PARAM_CR1,
        MDDR_DDRC_HPR_QUEUE_PARAM_CR2,
        MDDR_DDRC_LPR_QUEUE_PARAM_CR1,
        MDDR_DDRC_LPR_QUEUE_PARAM_CR2,
        ...
        MDDR_DDRC_DFI_WR_LVL_CONTROL_CR1,
        MDDR_DDRC_DFI_WR_LVL_CONTROL_CR2,
        MDDR_DDRC_DFI_RD_LVL_CONTROL_CR1,
        MDDR_DDRC_DFI_RD_LVL_CONTROL_CR2,
     ...
     */
    {
        ...
        MDDR_PHY_DQ_OFFSET_CR1,
        MDDR_PHY_DQ_OFFSET_CR2,
        MDDR_PHY_DQ_OFFSET_CR3,
        MDDR_PHY_DIS_CALIB_RST_CR,
        MDDR_PHY_DLL_LOCK_DIFF_CR,
        MDDR_PHY_FIFO_WE_IN_DELAY_CR1,
        MDDR_PHY_FIFO_WE_IN_DELAY_CR2,
        MDDR_PHY_FIFO_WE_IN_DELAY_CR3,
        MDDR_PHY_FIFO_WE_IN_FORCE_CR,
        MDDR_PHY_FIFO_WE_SLAVE_RATIO_CR1,
        MDDR_PHY_FIFO_WE_SLAVE_RATIO_CR2,
        MDDR_PHY_FIFO_WE_SLAVE_RATIO_CR3,
        MDDR_PHY_FIFO_WE_SLAVE_RATIO_CR4,
        MDDR_PHY_GATELVL_INIT_MODE_CR,
        MDDR_PHY_GATELVL_INIT_RATIO_CR1,
        MDDR_PHY_GATELVL_INIT_RATIO_CR2,
        MDDR_PHY_GATELVL_INIT_RATIO_CR3,
        MDDR_PHY_GATELVL_INIT_RATIO_CR4,
        MDDR_PHY_LOCAL_ODT_CR,
        MDDR_PHY_INVERT_CLKOUT_CR,
        MDDR_PHY_RD_DQS_SLAVE_DELAY_CR1,
        MDDR_PHY_RD_DQS_SLAVE_DELAY_CR2,
        MDDR_PHY_RD_DQS_SLAVE_DELAY_CR3,
        MDDR_PHY_RD_DQS_SLAVE_FORCE_CR,
        MDDR_PHY_RD_DQS_SLAVE_RATIO_CR1,
        MDDR_PHY_RD_DQS_SLAVE_RATIO_CR2,
        MDDR_PHY_RD_DQS_SLAVE_RATIO_CR3,
        MDDR_PHY_RD_DQS_SLAVE_RATIO_CR4,
        MDDR_PHY_WR_DQS_SLAVE_DELAY_CR1,
        MDDR_PHY_WR_DQS_SLAVE_DELAY_CR2,
        MDDR_PHY_WR_DQS_SLAVE_DELAY_CR3,
        MDDR_PHY_WR_DQS_SLAVE_FORCE_CR,
        MDDR_PHY_WR_DQS_SLAVE_RATIO_CR1,
        MDDR_PHY_WR_DQS_SLAVE_RATIO_CR2,
        MDDR_PHY_WR_DQS_SLAVE_RATIO_CR3,
        MDDR_PHY_WR_DQS_SLAVE_RATIO_CR4,
        MDDR_PHY_WR_DATA_SLAVE_DELAY_CR1,
        MDDR_PHY_WR_DATA_SLAVE_DELAY_CR2,
        MDDR_PHY_WR_DATA_SLAVE_DELAY_CR3,
        MDDR_PHY_WR_DATA_SLAVE_FORCE_CR,
        MDDR_PHY_WR_DATA_SLAVE_RATIO_CR1,
        MDDR_PHY_WR_DATA_SLAVE_RATIO_CR2,
        MDDR_PHY_WR_DATA_SLAVE_RATIO_CR3,
        MDDR_PHY_WR_DATA_SLAVE_RATIO_CR4,
        MDDR_PHY_WRLVL_INIT_MODE_CR,
        MDDR_PHY_WRLVL_INIT_RATIO_CR1,
        MDDR_PHY_WRLVL_INIT_RATIO_CR2,
        MDDR_PHY_WRLVL_INIT_RATIO_CR3,
        MDDR_PHY_WRLVL_INIT_RATIO_CR4,
     ...
     */
    {
        ...
        MDDR_DDR_FIC_LOCK_TIMEOUTVAL_CR1,
        MDDR_DDR_FIC_LOCK_TIMEOUTVAL_CR2,
...
const ddr_subsys_cfg_t g_m2s_fddr_subsys_config = 
{
     ...
     */
    {
        ...
        FDDR_DDRC_INIT_1_CR,
        FDDR_DDRC_CKE_RSTN_CYCLES_CR1,
        FDDR_DDRC_CKE_RSTN_CYCLES_CR2,
        ...
        FDDR_DDRC_ZQ_SHORT_INT_REFRESH_MARGIN_CR1,
        FDDR_DDRC_ZQ_SHORT_INT_REFRESH_MARGIN_CR2,
        FDDR_DDRC_PERF_PARAM_1_CR,
        FDDR_DDRC_HPR_QUEUE_PARAM_CR1,
        FDDR_DDRC_HPR_QUEUE_PARAM_CR2,
        FDDR_DDRC_LPR_QUEUE_PARAM_CR1,
        FDDR_DDRC_LPR_QUEUE_PARAM_CR2,
        ...
        FDDR_DDRC_DFI_WR_LVL_CONTROL_CR1,
        FDDR_DDRC_DFI_WR_LVL_CONTROL_CR2,
        FDDR_DDRC_DFI_RD_LVL_CONTROL_CR1,
        FDDR_DDRC_DFI_RD_LVL_CONTROL_CR2,
     ...
     */
    {
        ...
        FDDR_PHY_DQ_OFFSET_CR1,
        FDDR_PHY_DQ_OFFSET_CR2,
        FDDR_PHY_DQ_OFFSET_CR3,
        FDDR_PHY_DIS_CALIB_RST_CR,
        FDDR_PHY_DLL_LOCK_DIFF_CR,
        FDDR_PHY_FIFO_WE_IN_DELAY_CR1,
        FDDR_PHY_FIFO_WE_IN_DELAY_CR2,
        FDDR_PHY_FIFO_WE_IN_DELAY_CR3,
        FDDR_PHY_FIFO_WE_IN_FORCE_CR,
        FDDR_PHY_FIFO_WE_SLAVE_RATIO_CR1,
        FDDR_PHY_FIFO_WE_SLAVE_RATIO_CR2,
        FDDR_PHY_FIFO_WE_SLAVE_RATIO_CR3,
        FDDR_PHY_FIFO_WE_SLAVE_RATIO_CR4,
        FDDR_PHY_GATELVL_INIT_MODE_CR,
        FDDR_PHY_GATELVL_INIT_RATIO_CR1,
        FDDR_PHY_GATELVL_INIT_RATIO_CR2,
        FDDR_PHY_GATELVL_INIT_RATIO_CR3,
        FDDR_PHY_GATELVL_INIT_RATIO_CR4,
        FDDR_PHY_LOCAL_ODT_CR,
        FDDR_PHY_INVERT_CLKOUT_CR,
        FDDR_PHY_RD_DQS_SLAVE_DELAY_CR1,
        FDDR_PHY_RD_DQS_SLAVE_DELAY_CR2,
        FDDR_PHY_RD_DQS_SLAVE_DELAY_CR3,
        FDDR_PHY_RD_DQS_SLAVE_FORCE_CR,
        FDDR_PHY_RD_DQS_SLAVE_RATIO_CR1,
        FDDR_PHY_RD_DQS_SLAVE_RATIO_CR2,
        FDDR_PHY_RD_DQS_SLAVE_RATIO_CR3,
        FDDR_PHY_RD_DQS_SLAVE_RATIO_CR4,
        FDDR_PHY_WR_DQS_SLAVE_DELAY_CR1,
        FDDR_PHY_WR_DQS_SLAVE_DELAY_CR2,
        FDDR_PHY_WR_DQS_SLAVE_DELAY_CR3,
        FDDR_PHY_WR_DQS_SLAVE_FORCE_CR,
        FDDR_PHY_WR_DQS_SLAVE_RATIO_CR1,
        FDDR_PHY_WR_DQS_SLAVE_RATIO_CR2,
        FDDR_PHY_WR_DQS_SLAVE_RATIO_CR3,
        FDDR_PHY_WR_DQS_SLAVE_RATIO_CR4,
        FDDR_PHY_WR_DATA_SLAVE_DELAY_CR1,
        FDDR_PHY_WR_DATA_SLAVE_DELAY_CR2,
        FDDR_PHY_WR_DATA_SLAVE_DELAY_CR3,
        FDDR_PHY_WR_DATA_SLAVE_FORCE_CR,
        FDDR_PHY_WR_DATA_SLAVE_RATIO_CR1,
        FDDR_PHY_WR_DATA_SLAVE_RATIO_CR2,
        FDDR_PHY_WR_DATA_SLAVE_RATIO_CR3,
        FDDR_PHY_WR_DATA_SLAVE_RATIO_CR4,
        FDDR_PHY_WRLVL_INIT_MODE_CR,
        FDDR_PHY_WRLVL_INIT_RATIO_CR1,
        FDDR_PHY_WRLVL_INIT_RATIO_CR2,
        FDDR_PHY_WRLVL_INIT_RATIO_CR3,
        FDDR_PHY_WRLVL_INIT_RATIO_CR4,
     ...
     */
    {
        ...
        FDDR_DDR_FIC_LOCK_TIMEOUTVAL_CR1,
        FDDR_DDR_FIC_LOCK_TIMEOUTVAL_CR2,
...
#include "sys_config_serdes_0_define.h"
#endif

#if MSS_SYS_SERDES_1_CONFIG_BY_CORTEX
#include "sys_config_serdes_1_define.h"
#endif

#if MSS_SYS_SERDES_2_CONFIG_BY_CORTEX
#include "sys_config_serdes_2_define.h"
#endif

#if MSS_SYS_SERDES_3_CONFIG_BY_CORTEX
#include "sys_config_serdes_3_define.h"
#endif
