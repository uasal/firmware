//////////////////////////////////////////////////////////////////////
// Created by SmartDesign Fri Nov  7 15:04:02 2025
...
//////////////////////////////////////////////////////////////////////
/*
# Exporting Component Description of CoreSF2Reset_C1 to TCL
# Family: SmartFusion2
# Part Number: M2S010-TQ144I
# Create and Configure the core component CoreSF2Reset_C1
create_and_configure_core -core_vlnv {Actel:DirectCore:CoreSF2Reset:3.0.100} -component_name {CoreSF2Reset_C1} -params {\
"DDR_WAIT:200"  \
"DEVICE_VOLTAGE:2"  \
"EXT_RESET_CFG:3"  \
"FDDR_IN_USE:false"  \
...
"SDIF2_IN_USE:false"  \
"SDIF3_IN_USE:false"   }
# Exporting Component Description of CoreSF2Reset_C1 to TCL done
*/

// CoreSF2Reset_C1
module CoreSF2Reset_C1(
    // Inputs
    CLR_INIT_DONE,
    CONFIG_DONE,
    EXT_RESET_IN_N,
